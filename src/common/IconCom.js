...
import EntypoIcon from 'react-native-vector-icons/Entypo'; //MOre libereary after slash 
...
export const GoogleIcon = (props) => <Icon name="google" size={props.size} style={props.style} />
export const FacebookIcon = (props) => <Icon name="facebook" size={props.size} style={props.style} />
export const UserIcon = (props) => <Icon name="face-man" size={props.size} style={props.style} />
export const CheckIcon = (props) => <EntypoIcon name="check" size={props.size} style={props.style} onPress={props.onPress} />
export const PendingIcon = (props) => <Icon name="dots-horizontal" size={props.size} style={props.style} />
export const LogoutIcon = (props) => <Icon name="logout" size={props.size} style={props.style} />
export const EnterIcon = (props) => <AntDesignIcon name="enter" size={props.size} style={props.style} onPress={props.onPress} />
...
export const ViewIcon = (props) => <AntDesignIcon name="eye" size={props.size} style={props.style} onPress={props.onPress} />
export const MenuIcon = (props) => <Icon name="menu" size={props.size} style={props.style} onPress={props.onPress} />
// menufold
// export const FacebookButton = <Icon.Button name="facebook" backgroundColor="#3b5998" onPress={() => alert('Login with Facebook')}> Login with Facebook</Icon.Button>
